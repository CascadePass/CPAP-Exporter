...
namespace CascadePass.CPAPExporter
{
    ...
    /// a given <see cref="IStylingCue"/>.</remarks>
    public interface IStylingCueProvider
    {
        ...
        Brush GetAttentionStripeBrush(IStylingCue message);
        ...
        double GetAttentionStripeWidth(IStylingCue message);
        ...
        Brush GetForegroundBrush(IStylingCue message);
        ...
        Brush GetBackgroundBrush(IStylingCue message);
        ...
        Brush GetStatusPanelBorderBrush(IStylingCue message);
        ...
        /// message.</returns>
        Thickness GetBorderThickness(IStylingCue message);
        ...
        double GetCornerRadius(IStylingCue message);
        ...
        bool GetFadeIn(IStylingCue message);
        ...
        /// <returns>The fade in setting as a <see cref="bool"/>.</returns>
        bool GetFadeOut(IStylingCue message);
        ...
        bool GetPulseBorder(IStylingCue message);
        ...
        Color GetPulseEndColor(IStylingCue message);
        ...
        Color GetPulseStartColor(IStylingCue message);
        ...
        bool GetShowDropShadow(IStylingCue message);

        #region Shadow Values

        Color GetShadowColor(IStylingCue message);
        double GetShadowOpacity(IStylingCue message);
        double GetShadowBlurRadius(IStylingCue message);
        double GetShadowDepth(IStylingCue message);
